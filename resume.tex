    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Software Architecture Document}
          {
            카네기 멜론대 SEI에서 제안한 \textit{Software Architecture Document (SAD)} 템플릿을 기반으로 데이터 플랫폼의 구성요소와 운영·관리 뷰를 정리했습니다. 
            품질속성 중심의 의사결정 관리를 위해 ADR(Architecture Decision Record)을 병행했고, 
            \texttt{mkdocs}와 S3를 활용해 문서 접근성과 버전 관리 체계를 구축했습니다.
          }
        \resumeItem{Data API}
